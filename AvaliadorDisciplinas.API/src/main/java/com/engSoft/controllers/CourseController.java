...
public class CourseController {
    ...
    public ResponseEntity<?> createCourse(@RequestBody CourseDTO courseDTO) {
        Optional<Teacher> optionalTeacher = teacherService.findTeacherByName(courseDTO.getNameTeacher());
    ...
    @RequestMapping(value = "/Courses/{nameTeacher}", method = RequestMethod.GET)
    public ResponseEntity<?> getAllCoursesfromTeacher(@PathVariable("nameTeacher") Long nameTeacher){
        Optional<Teacher> optionalTeacher = teacherService.findTeacherByName(nameTeacher);
