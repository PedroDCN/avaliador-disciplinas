...
export function menuItems(){
  return {
    ...
    "disciplina/cadastro": { title: "Cadastrar disciplina", icon: DisciplinasIcon },
    "disciplina/edicao": { title: "Cadastrar disciplina", icon: DisciplinasIcon },
...
export function getMenuItemsByUserMode(mode) {
  ...
  if (mode === "anonimous") {
    ...
    menuItems = ["disciplinas","professores","disciplina/cadastro",
      "professor/cadastro","denuncias","logout"]
  }
  return menuItems;
}